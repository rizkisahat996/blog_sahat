    ...
    <div class="row">
        <div class="col-lg-3 col-md-12 mb-5">
            <a href="index.html" class="navbar-brand">
                <h1 class="mb-2 mt-n2 display-5 text-uppercase"><span class="text-primary">maner</span>ser</h1>
            </a>
        ...
        <div class="col-lg-3 col-md-6 mb-5">
            ...
            <div class="d-flex flex-wrap m-n1">
                ...
                <a href="/posts?category={{ $item->slug }}" class="btn btn-sm btn-outline-secondary m-1">{{ $item->name }}</a>
                @endforeach
            </div>
        </div>
        <div class="col-lg-3 col-md-6 mb-5">
