<header class="header">
          ...
          <div class="col-lg-4 d-none d-lg-block text-end">
            <div class="dropdown text-sm"><a class="reset-anchor dropdown-toggle" id="destinations" href="#" data-bs-toggle="dropdown" data-bs-display="static" aria-haspopup="true" aria-expanded="false"><i class="fas fa-globe-americas me-2"></i>Option</a>
              <div class="dropdown-menu dropdown-menu-end mt-3" aria-labelledby="destinations">
                ...
                <a class="dropdown-item text-sm" href="/logout" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" type="submit">Logout</a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white py-4">
      <div class="container text-center"><a class="navbar-brand mx-auto" href="#"><img src="/blog/img/logoo.png" alt="" width="200" height="210">
          <p class="text-sm text-uppercase text-gray">They Say Schools Are Useless</p>
          <p class="text-sm text-uppercase text-gray">Unfortunately, Yes They Are Right...</p></a></div>
    </nav>
    <!-- Navbar 2 -->
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse text-center" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto">
            ...
            <li class="nav-item px-1">
              <!-- Link--><a class="nav-link {{ Request::is('categories') ? 'active' : '' }}" href="/categories">Category</a>
            </li>
            <li class="nav-item px-1 dropdown"><a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Pages</a>
              <div class="dropdown-menu text-center text-lg-start shadow-sm" aria-labelledby="navbarDropdownMenuLink"><a class="dropdown-item" href="/">Home</a><a class="dropdown-item" href="/posts">Post</a><a class="dropdown-item" href="/categories">Category</a></div>
            </li>
          </ul>
        </div>
      </div>
